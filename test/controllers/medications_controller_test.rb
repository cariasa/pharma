...
class MedicationsControllerTest < ActionController::TestCase
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post :create, medication: { brand_id: @medication.brand_id, category_id: @medication.category_id, description: @medication.description, medication: @medication.medication }
    end
  ...
  test "should update medication" do
    patch :update, id: @medication, medication: { brand_id: @medication.brand_id, category_id: @medication.category_id, description: @medication.description, medication: @medication.medication }
    assert_redirected_to medication_path(assigns(:medication))
  end
