...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { concentration: @presentation.concentration, presentation: @presentation.presentation, units: @presentation.units }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { concentration: @presentation.concentration, presentation: @presentation.presentation, units: @presentation.units }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
